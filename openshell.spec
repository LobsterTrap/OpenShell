...
Name:           openshell
Version:        0.0.22
Release:        1.20260427110015227991.midstream.refactor.93.ga82c193%{?dist}
Summary:        Safe, sandboxed runtimes for autonomous AI agents

License:        Apache-2.0
URL:            https://github.com/LobsterTrap/OpenShell
Source0: openshell-0.0.22.tar.gz
Source1: openshell-0.0.22-vendor.tar.xz
...
# real tags in the ghcr.io/lobstertrap/openshell registry.
...
Documentation=https://github.com/LobsterTrap/OpenShell
...
OPENSHELL_SUPERVISOR_IMAGE=ghcr.io/lobstertrap/openshell/supervisor:latest
